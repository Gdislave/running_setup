...
int main(int argc, char **argv){
    ...
    ros::Publisher kinectProc = nh.advertise<sensor_msgs::Image>("/depth_filtered", 10);
    ros::Publisher kinectProcInfo = nh.advertise<sensor_msgs::CameraInfo>("/depth_filtered/camera_info", 10);
